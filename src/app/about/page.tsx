        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          <section className="space-y-8">
            <div className="p-8 rounded-[var(--border-radius-lg)] bg-glass border border-glass-border backdrop-blur-[var(--blur-glass)]">
              ...
              <p className="font-celestial text-text leading-relaxed">
          ...
          <section className="space-y-8">
            <div className="p-8 rounded-[var(--border-radius-lg)] bg-glass border border-glass-border backdrop-blur-[var(--blur-glass)]">
              ...
              <p className="font-celestial text-text leading-relaxed italic">
                &ldquo;Explore the unseen without losing yourself in it.&rdquo;
              </p>
              <p className="font-celestial text-muted mt-4 text-sm leading-relaxed">
