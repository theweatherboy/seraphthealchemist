...
export default async function AdminPage({ searchParams }: { searchParams: Promise<{ error?: string; saved?: string }> }) {
  ...
  return <section className="account-page admin-page"><div className="account-panel">
    ...
    <div className="account-links"><Link href="/admin/scheduling">Open scheduling workspace</Link><Link href="/account">Return to my account</Link></div>
  </div></section>;
}
