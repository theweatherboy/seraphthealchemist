    ...
    return (
      <div className="h-screen flex items-center justify-center text-center p-4">
        <div className="max-w-md">
          <h1 className="font-arcane text-4xl text-gold mb-4">Path Not Found</h1>
          <p className="font-celestial text-muted mb-8">The offering you seek is currently hidden in the mists.</p>
          <Link href="/services" className="px-6 py-2 font-arcane text-gold border border-gold/50 rounded-full hover:bg-gold hover:text-obsidian transition-all">
            Return to Offerings
          </Link>
        </div>
      </div>
