...
export const defaultNavigation = [
  { href: '/', label: 'Home', sort_order: 0 }, { href: '/about', label: 'About', sort_order: 1 }, { href: '/services', label: 'Services', sort_order: 2 }, { href: '/birth-chart', label: 'Birth Chart', sort_order: 3 }, { href: '/grimoire', label: 'Grimoire', sort_order: 4 }, { href: '/reviews', label: 'Testimonies', sort_order: 5 }, { href: '/forge', label: 'Offerings', sort_order: 6 }, { href: '/support', label: 'Support', sort_order: 7 }, { href: '/contact', label: 'Connect', sort_order: 8 }, { href: '/account', label: 'Account', sort_order: 9 }, { href: '/terms-of-service', label: 'Terms of Service', sort_order: 10 }, { href: '/privacy-policy', label: 'Privacy Policy', sort_order: 11 },
] as const;
